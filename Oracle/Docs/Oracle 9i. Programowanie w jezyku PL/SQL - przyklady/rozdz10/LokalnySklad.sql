REM LokalnySklad.sql
REM Rozdzia³ 10., Scott Urman - Oracle9i Programowanie w jêzyku PL/SQL
REM Ta procedura zawiera podprogram lokalny.

set serveroutput on

CREATE OR REPLACE PROCEDURE ProcSklad AS
  /* Deklaracje lokalne kursora, zmiennych oraz funkcji. */
