REM TrwaloscPakietu.sql
REM Rozdzia³ 10., Scott Urman - Oracle9i Programowanie w jêzyku PL/SQL
REM Ten pakiet demonstruje trwa³oœæ zmiennych zadeklarowanych w pakiecie.
...
CREATE OR REPLACE PACKAGE BODY TrwaloscPakietu AS
  -- Zapytanie do tabeli studenci.  Poniewa¿ dla treœci pakietu ma ono
  -- globalny zasiêg, pozostanie aktywne poza wywo³aniem z bazy danych.
